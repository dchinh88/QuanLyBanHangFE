...
import { useCongnovoinhacungcap } from './components/congnovoinhacungcap/congnovoinhacungcap.store';
import { serviceKho } from './components/kho/kho';
// import { service } from './components/kho/kho';
import numeral from 'numeral';
// import AddKho from '../components/kho/AddKho.vue';
// import EditKho from '../components/kho/EditKho.vue';

const { fetchCongnovoinhacungcap, query } = useCongnovoinhacungcap();
...
const getAllCongnocuakhachhang = async () => {
  const res = await fetchCongnovoinhacungcap();
  congnovoinhacungcap.value = res.data;
  lengthPage.value = Math.ceil(res.totalItems / selectedValue.value);
  totalItems.value = res?.totalItems;

  const congnoLength = congnovoinhacungcap.value.length;
    ...
    <v-row class="mr-2">
      <v-col cols="12">
        <v-table style="border-radius: 12px 12px 0 0">
          ...
          <tbody>
            <tr v-for="(item, i) in congnovoinhacungcap" :key="i">
